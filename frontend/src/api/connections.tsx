...
async function get_connection_metadata_api(id: string) {
    return request("/api/connections/"+id,"GET",{});
}
...
export const useGetConnectionMetadataApi = () => useCustomFetch<TableMetadataDto,typeof get_connection_metadata_api>(get_connection_metadata_api);